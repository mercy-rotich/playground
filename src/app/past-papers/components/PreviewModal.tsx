...
import { X, Download, Upload, ExternalLink, FileText } from 'lucide-react'
...
export default function PreviewModal({ paper, isOpen, onClose, onDownload, onUploadToAI }: PreviewModalProps) {
        ...
        <div className="flex items-center justify-between p-4 border-b border-dark-lighter flex-shrink-0">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-primary text-dark rounded-lg font-medium text-sm hover:bg-primary-dark transition-colors"
            >
          ...
          <div className="w-full h-full flex items-center justify-center">
            <div className="text-center p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  onClick={() => onDownload(paper)}
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-primary text-dark rounded-xl font-semibold hover:bg-primary-dark transition-colors"
                >
