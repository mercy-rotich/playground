  ...
  return (
    <section id="faq" className="section-padding bg-[#0F0F0F]">
      <div className="container-custom max-w-[1000px]">
        ...
        <div className="flex flex-col gap-6">
          {faqs.map((faq, index) => (
            <div
              ...
              style={{
                borderColor: activeIndex === index ? 'var(--primary)' : '#2A2A2A',
              }}
            >
              {/* Question */}
              <button
                onClick={() => toggleFAQ(index)}
                className={`w-full px-8 py-7 flex justify-between items-center gap-4 text-left transition-all ${
              ...
              >
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-2xl flex-shrink-0 transition-all ${
                    activeIndex === index
              ...
              >
                <div className="px-8 pb-7">
                  <div
                    className="text-text-gray text-[1.05rem] leading-[1.7] pl-10"
        ...
        {/* CTA Box */}
        <div
          className="mt-12 text-center p-10 rounded-2xl border-2"
          style={{
